                ...
                <div class="d-flex justify-content-start flex-md-wrap flex-wrap espacioLateralCYM">
                    <div class="col-md-12 my-5">
                        <div class="col-md-12 center my-3">
                            <h2 class="colorBlack">Inventarios</h2>
                        </div>
                        <section>
                            <div class="container py-5">
                                <div class="main-timeline">
                                    <div class="timeline left">
                                        <div class="card contorno ">
                                            <div class="card-body p-4">
                                                <a class="colorA" href="2025/inventarios/inventario_2025.pdf" target="_blank">
                                                    <h3>2025</h3>
                                                    <p class="mb-0">Consultar</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="timeline right">
                                        <div class="card contorno ">
                                            <div class="card-body p-4">
                                                <a class="colorA" href="2025/inventarios/inventario_2024.pdf" target="_blank">
                                                    <h3>2024</h3>
                                                    <p class="mb-0">Consultar</p>
                                                </a>
                                            </div>
                                    ...
                                    <div class="timeline left">
                                        <div class="card contorno ">
                                            <div class="card-body p-4">
                                                <a class="colorA" href="2025/inventarios/inventario_2019-T1.pdf" target="_blank">
                                                    <h3>2019</h3>
                                                    <p class="mb-0">Consultar</p>
                                                </a>
                                            </div>
                                    ...
                                    <div class="timeline right">
                                        <div class="card contorno ">
                                            <div class="card-body p-4">
                                                <a class="colorA" href="2025/inventarios/inventario-2018-T4.pdf" target="_blank">
                                                    <h3>2018</h3>
                                                    <p class="mb-0">Consultar</p>
                                                </a>
                                            </div>
